...
ctcf_reader = ChiPSeqReader("../GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak",
                                                            name="CTCF")
#читаем файл
ctcf_reader.read_file()
#устанавливаем ориентация мотивов CTCF, для этого нужен доп файл с ориентациями
ctcf_reader.set_sites_orientation("../GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak-orient.bed")
